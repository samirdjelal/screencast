		...
		return (
			<div className="Header h-10 px-4 leading-10 bg-gray-800 border-b border-gray-900 flex">
				...
				<div className="Menu flex pt-2 space-x-2">
					...
					<div className="Item w-6 h-6" onClick={this.props.getVideoSources}>
						<svg className="fill-current cursor-pointer text-gray-500 hover:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
					...
					<div className="Item w-6 h-6" onClick={this.props.startRecording}>
						<svg className="fill-current cursor-pointer text-gray-500 hover:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
							<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clipRule="evenodd"/>
						</svg>
					</div>
					<div className="Item w-6 h-6" onClick={this.props.stopRecording}>
						<svg className="fill-current cursor-pointer text-gray-500 hover:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
				...
				<div className="Title flex-1 text-gray-500">Screencast v1.0 {this.props.status === 'recording' && '🔴'}</div>
